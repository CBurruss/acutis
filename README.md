...
║ str               ║ num  ║ num ║ num  ║ num ║ num  ║ num   ║ num   ║ num ║ num ║ num  ║ num  ║ 
╠═══════════════════╬══════╬═════╬══════╬═════╬══════╬═══════╬═══════╬═════╬═════╬══════╬══════╣ 
...
```
╔═════╦════════════╦═══════════╦═════╦══════════════════╗ 
║ row ║ first_name ║ birth_day ║ age ║ anniversary_date ║ 
║ str ║ str        ║ str       ║ str ║ str              ║ 
╠═════╬════════════╬═══════════╬═════╬══════════════════╣ 
...
```r
df |> 
  mutate(anniversary_date_clean = fix_date_mdy(Anniversary.date)) |>
  select(Anniversary.date, anniversary_date_clean) |> 
  affiche()
```

```
╔═════╦══════════════════╦════════════════════════╗ 
║ row ║ Anniversary.date ║ anniversary_date_clean ║ 
║ str ║ str              ║ str                    ║ 
╠═════╬══════════════════╬════════════════════════╣ 
...
```r
df |> 
  mutate(birth_day_clean = fix_date_ymd(Birth.Day)) |>
  select(Birth.Day, birth_day_clean) |> 
  affiche()
```

```
╔═════╦═══════════╦═════════════════╗ 
║ row ║ Birth.Day ║ birth_day_clean ║ 
║ str ║ str       ║ date            ║ 
╠═════╬═══════════╬═════════════════╣ 
...
```r
df |> 
  filter(not.na(Birth.Day)) |> 
  affiche()
```

```
╔═════╦════════════╦═══════════╦═════╦══════════════════╗ 
║ row ║ First.Name ║ Birth.Day ║ Age ║ Anniversary.date ║ 
║ str ║ str        ║ str       ║ str ║ str              ║ 
╠═════╬════════════╬═══════════╬═════╬══════════════════╣ 
║ 1   ║  Henry     ║ 20031229  ║ 22  ║ 02/13/2015       ║
║ 2   ║ BOB        ║ 19800515  ║ NA  ║ 10/20/1997       ║
